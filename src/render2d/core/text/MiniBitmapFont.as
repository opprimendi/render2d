...
package render2d.core.text
{
    ...
    public class MiniBitmapFont
    {
        ...
        public static const BITMAP_HEIGHT:int = 64;
        ...
        public static function get texture():TextureBase
        {
            var bitmapData:BitmapData = getBitmapData();
			//var texture:Texture = new TextureMaterial(new BitmapTexture(bitmapData));
            //bitmapData.dispose();
            //bitmapData = null;
            //return texture;
			return null;
